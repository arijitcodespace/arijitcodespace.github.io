...
[Projects](/projects/){: .btn .btn--info}
...
- **Convergence of Asynchronous Stochastic Gradient Descent for Polyak-Łojasiewicz Functions** (submitted to IEEE Transactions on Automatic Control). [PDF](/assets/papers/paper.pdf) · [Code](https://github.com/arijitcodespace/Asynchronous-SGD)

### Selected projects

- **GNN-Keras3:** Graph neural network training/inference library in TensorFlow/Keras. [Repo](https://github.com/arijitcodespace/GNN-Keras3) · [Docs](/docs/overview/)
...
If you'd like the detailed version (with milestones, metrics, and links), see **[Research](/research/)** and **[Projects](/projects/)**.
